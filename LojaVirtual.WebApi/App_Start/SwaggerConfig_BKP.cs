...
{
    public class SwaggerConfig_BKP
    {
        public static void Register(HttpConfiguration config)
        {
            var thisAssembly = typeof(SwaggerConfig_BKP).Assembly;
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.ApiKey("Authorization", "header", "API Autenticação");
                        //
                        //c.OAuth2("oauth2")
                ...
                .EnableSwaggerUi(c =>
                    {
                        ...
                        //c.ApiKeySupport("X-ApiKey", "header");
